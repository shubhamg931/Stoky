...
import {Picker, Container, Icon, Content, Form, Item, Label, Input, Button, Card, CardItem, Right } from "native-base";
...
class AddScreen extends React.Component {
  ...
  addToStock = () => {
    console.log("Add to stock function called!");
    this.props.addToStock(this.state);
    this.setState({
      list: [],
    });
    ...
    return (
        <Container>
          <Content>
            ...
            />
            <Button block info style={styles.registerButtonStyle} onPress={() => {this.addToStock()}}>
              <Text style={{color: 'white'}}>Add To Stock</Text>
            </Button>
